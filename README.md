A collective list of production-ready free and paid APIs for use in software and web development.

## Contributing to public-apis

Both free and paid APIs are allowed in this list. Open a request with the details of your API and it will get reviewed and merged.
...
| [CurrencyScoop](https://currencyscoop.com/api-documentation) | Real-time and historical currency rates | `apiKey` | Yes | Unknown |
...
| [DynamicDocs](https://advicement.io) | JSON to PDF API based on LaTeX templates | `apiKey` | Yes | Unknown |
